...
interface LineChartDailyConversationProps {}
...
const LineChartDailyConversation: React.FC<
  LineChartDailyConversationProps
> = () => {
  ...
  return (
    <div className="w-full border border-[#EEF5FF] rounded-lg relative">
      <div className="flex items-center gap-1 px-4 py-6">
        <p className="font-medium text-[#67768B]">
          Daily Resolved Conversations per Agent
        </p>
      ...
      />
      <Bubble
        anchor="daily_conversation_chart"
