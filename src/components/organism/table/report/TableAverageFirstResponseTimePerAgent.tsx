...
interface TableAverageFirstResponseTimePerAgentProps {
  data?: IAgentDurationConversation[];
}

const TableAverageFirstResponseTimePerAgent: React.FC<
  TableAverageFirstResponseTimePerAgentProps
> = ({ data }) => {
  ...
  return (
    <TableReportContainer
      title="Average First Response Time per Agent"
      anchor="TableAverageFirstResponseTimePerAgent"
      text=""
      emptyMsg="No result"
      columns={columns}
      data={data}
...
export default TableAverageFirstResponseTimePerAgent;
